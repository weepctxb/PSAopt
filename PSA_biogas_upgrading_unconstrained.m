...
xcoord = linspace(50,1000); % Pswing
ycoord = linspace(1,30); % tfeed
zcoord = x(3); % L/D
...
clearvars xcoord ycoord zcoord fcoord;
xcoord = linspace(1,1000); % Pswing
ycoord = x(2); % tfeed
zcoord = linspace(1,20); % L/D
